...
-- Enable Realtime on tables (needed for Phase 2E)
alter publication supabase_realtime add table public.slots;
alter publication supabase_realtime add table public.slot_history;

-- Process Bid Function
-- This function MUST be atomic (single transaction) to prevent race conditions
