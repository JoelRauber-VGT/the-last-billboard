  ...
  return (
    <div className="w-full min-h-screen bg-term-bg py-16 px-6">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 font-mono text-base leading-relaxed text-term-text">
          {/* Left Column */}
          <div className="space-y-10">
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('acceptance.title')}</h2>
              <p>{t('acceptance.text')}</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('service.title')}</h2>
              <p>{t('service.description')}</p>
              <p>{t('service.freeze')}</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('account.title')}</h2>
              <p>{t('account.magicLink')}</p>
              <p>{t('account.responsibility')}</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('bidding.title')}</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('content.title')}</h2>
              <p>{t('content.intro')}</p>
            ...
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('payment.title')}</h2>
          ...
          <div className="space-y-10">
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('liability.title')}</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('indemnification.title')}</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('termination.title')}</h2>
              <p>{t('termination.text')}</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('law.title')}</h2>
              {jurisdiction ? (
            ...
            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('changes.title')}</h2>
              <p>{t('changes.text')}</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('severability.title')}</h2>
              <p>{t('severability.text')}</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg text-white">{t('contact.title')}</h2>
              <p>{t('contact.text')}</p>
              {legalEmail ? (
                <p>
